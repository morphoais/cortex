...
- name: <string>  # API name (required)
  ...
  definition:
    ...
    image: <string> # docker image to use for the Task (default: public.ecr.aws/x6x7z2q3/mor-cortex/python-predictor-cpu:0.31.1, public.ecr.aws/x6x7z2q3/mor-cortex/python-predictor-gpu:0.31.1-cuda10.2-cudnn8, or public.ecr.aws/x6x7z2q3/mor-cortex/python-predictor-inf:0.31.1 based on compute)
