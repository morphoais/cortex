...
1. Check [go-yaml/yaml](https://github.com/go-yaml/yaml/commits/v2) to see if there were new releases
   since [cortexlabs/yaml](https://gitlab.com/g-ogawa/yaml/commits/v2)
...
1. Check [tcnksm/go-input](https://github.com/tcnksm/go-input/commits/master) to see if there were new releases
   since [cortexlabs/go-input](https://gitlab.com/g-ogawa/go-input/commits/master)
...
1. `go get gitlab.com/g-ogawa/yaml@581aea36a2e4db10f8696587e48cac5248d64f4d`
1. `go get gitlab.com/g-ogawa/go-input@8b67a7a7b28d1c45f5c588171b3b50148462b247`
...
1. You can confirm the metric server is running by showing the logs of the metrics-server pod, or
   ...
   and `kubectl get apiservice v1.metrics.k8s.io -o yaml`
